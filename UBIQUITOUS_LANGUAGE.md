...
| **Channel Capability** | A static board-design ability of a Virtual Voltage Channel, such as on/off, raw output drive, voltage measurement, current measurement, raw calibration access, or hardware status. Capabilities are derived from devicetree/Kconfig composition and are not dynamically negotiated at runtime. | Inferring capability from C function presence; treating capability as runtime configuration |
