...
// truth shared by every client (see channel_policy.h), so the Status
// column's display, its click handler, and psb_demo_gui's Monitor/Channel
// views can never disagree with each other. Status shows n/a when neither
// capability is present.
using psb::channelIsOn;
